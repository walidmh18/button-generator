...
textShadow.addEventListener('input', () => {
    ...
    if (textShadow.checked) {
        ...
        let textShadowValues = {X:textshX.value + 'px' , Y:textshY.value + 'px' , Blur:textshBlur.value + 'px' , Color:textshColor.value}
        ...
        const textshXBlur_ = document.querySelector('#textshBlur_')
        textshBlur_.innerHTML = textShadowValues.Blur
        ...
        // console.log(`${textShadowValues.X} ${textShadowValues.Y} ${textShadowValues.Blur} ${textShadowValues.color}`);
...
const bgcolorPreview = document.querySelector('.colorPickerPreview[for="bgcolor"]').querySelector('div')
...
bgGradient.addEventListener('input', () => {
    if (bgGradient.checked) {
        ...
        bgcolor.parentElement.style.textDecoration = 'line-through #72a1cb solid 3px'
        ...
        let bgGradientValues = {color1:color1.value , color2:color2.value , direction:direction.value + 'deg'}
...
document.getElementById('paddingBottom_').innerHTML = paddingBottom.value + 'px'

detailedPaddings.addEventListener('input', () => {
    if (detailedPaddings.checked) {
        secondaryPaddingSec.classList.remove('disabled')
        padding.parentElement.style.textDecoration = 'line-through #72a1cb solid 3px'
        cssStyles.padding = ''
...
detailedBorderRadius.addEventListener('input', () => {
    if (detailedBorderRadius.checked) {
        ...
        borderRadius.parentElement.style.textDecoration = 'line-through #72a1cb solid 3px'
        ...
        let borderRadiusValues = {tr : borderRadiusTopRight.value + 'px',
                                  br : borderRadiusBottomRight.value + 'px', 
                                  bl : borderRadiusBottomLeft.value + 'px', 
                                  tl : borderRadiusTopLeft.value + 'px'}
                                //   console.log(borderRadiusValues);
        document.getElementById('borderRadiusTopRight_').innerHTML = borderRadiusValues.tr
        ...
        document.getElementById('borderRadiusBottomRight_').innerHTML = borderRadiusValues.br
        ...
        document.getElementById('borderRadiusBottomLeft_').innerHTML = borderRadiusValues.bl
        ...
        document.getElementById('borderRadiusTopLeft_').innerHTML = borderRadiusValues.tl
...
let borderValues = {color: borderColor.value , width: borderWidth.value+'px' , style: borderStyle.value }
...
detailedBorder.addEventListener('input' ,() => {
    if (detailedBorder.checked) {
        ...
        detailedBorder.parentElement.previousElementSibling.style.textDecoration = 'line-through #72a1cb solid 3px'
        // variables
        const borderTopColor = document.getElementById('borderTopColor')
        const borderTopColorPreview = document.getElementById('borderTopColorPreview')
        ...
        // values object
        let borderTopValues = {color : borderTopColor.value, width:borderTopWidth.value+'px', style:borderTopStyle.value}
        ...
        const borderRightColorPreview = document.getElementById('borderRightColorPreview')
        const borderRightWidthPreview = document.getElementById('borderRightWidth_')


        // values object
        let borderRightValues = {color : borderRightColor.value, width:borderRightWidth.value+'px', style:borderRightStyle.value}
        ...
        const borderBottomColorPreview = document.getElementById('borderBottomColorPreview')
        const borderBottomWidthPreview = document.getElementById('borderBottomWidth_')

        // values object
        let borderBottomValues = {color : borderBottomColor.value, width:borderBottomWidth.value+'px', style:borderBottomStyle.value}
        ...
        const borderLeftColorPreview = document.getElementById('borderLeftColorPreview')
        const borderLeftWidthPreview = document.getElementById('borderLeftWidth_')
        // values object
        let borderLeftValues = {color : borderLeftColor.value, width:borderLeftWidth.value+'px', style:borderLeftStyle.value}
        ...
        btn.style.border = `${borderValues.color} ${borderValues.width} ${borderValues.style}`
        detailedBorder.parentElement.previousElementSibling.style.textDecoration = 'none'
        cssStyles.border = `border: ${borderValues.color} ${borderValues.width} ${borderValues.style};`
        cssStyles.borderTop = ''
...
let boxShadowValues = {x: boxShadowX.value+'px' , y: boxShadowY.value+'px' , blur: boxShadowBlur.value+'px' , color: boxShadowColor.value , transparency: Math.round(boxShadowAlpha.value * 2.55).toString(16) }
boxShadow.addEventListener('input',() => {
    if (boxShadow.checked) {
        ...
        boxShadowX.addEventListener('input',() => {
            ...
            btn.style.boxShadow = `${boxShadowValues.x} ${boxShadowValues.y} ${boxShadowValues.blur} ${boxShadowValues.color + boxShadowValues.transparency}`
            cssStyles.boxShadow = `box-shadow: ${boxShadowValues.x} ${boxShadowValues.y} ${boxShadowValues.blur} ${boxShadowValues.color + boxShadowValues.transparency};`
        })
        ...
        boxShadowAlpha.addEventListener('input', () => {
            ...
            boxShadowValues.transparency = boxshHex.length == 1 ? 0 + boxshHex : boxshHex 
            btn.style.boxShadow = `${boxShadowValues.x} ${boxShadowValues.y} ${boxShadowValues.blur} ${boxShadowValues.color + boxShadowValues.transparency}`           
            cssStyles.boxShadow = `box-shadow: ${boxShadowValues.x} ${boxShadowValues.y} ${boxShadowValues.blur} ${boxShadowValues.color + boxShadowValues.transparency};`
        })
    } else {
...
function applyCss(){
    for (const key in cssStyles) {
        if (cssStyles[key]!= '' && cssStyles[key]!= null) {
            ...
            console.log(cssStyles[key]);
        }
    }
}
// console.log(approvedStyles);
